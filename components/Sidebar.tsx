      ...
      `}>
        ...
        <div className="p-6 mt-auto">
          <button
            ...
            className={`w-full flex items-center justify-center gap-2 px-4 py-3 text-[10px] font-black uppercase tracking-widest rounded-full transition-all border ${
              currentPage === Page.ADMIN 
                ? 'bg-black text-white border-black' 
                : 'text-black/30 border-black/10 hover:border-black/40 hover:text-black'
            }`}
          >
            <Lock size={12} />
            Access Admin
